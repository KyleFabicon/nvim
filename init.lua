--[[
  ...
  `:checkhealth` more info on errors.
--]]
...
require('lazy').setup({
  ...
  { -- Lazy Git
    ...
    keys = {
      ...
      { '<leader>li', '<cmd>LazyGitFilter<cr>', desc = '[L]azyGit f[I]lter' },
      { '<leader>ll', '<cmd>LazyGitFilterCurrentFile<cr>', desc = '[L]azyGit fi[L]ter Current File' },
    },
  },
